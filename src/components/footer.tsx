import img from "../assets/images/sadaham (1).png";
        ...
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0 flex items-center">
            <a href="" className="flex items-center">
              <img
                src={img}
                className="w-28 h-28 md:w-40 md:h-40 object-cover rounded-full mr-4 "
                alt=""
              />
              <h1 className="font-semibold whitespace-nowrap dark:text-white text-5xl w-40 h-20 mt-2">
                සදහම්
              </h1>
            </a>
          </div>
